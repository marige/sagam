...
public class Modification extends javax.swing.JDialog{
    ...
    private void initComponents() {
        ...
        txtComptePrincipal.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtCodeP, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap())
                    .addGroup(layout.createSequentialGroup()
...
COMPTEP cp = new COMPTEP();
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(reponse==JOptionPane.YES_OPTION){
            try {
                ...
                String champ[]={"LIBCOMPTEP"};
                String valeur[]={txtComptePrincipal.getText()};
                JOptionPane.showMessageDialog(this,cp.getIdCompteP());
                int i=cp.updateTable("comptep", champ, valeur,"where idcomptep="+cp.getIdCompteP());
                JOptionPane.showMessageDialog(this, i+" compte principale modifié");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
       txtComptePrincipal.setText(cp.getLibCompteP());
       txtCodeP.setText(String.valueOf(cp.getIdCompteP()));
