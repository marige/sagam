...
public class Amortissement extends javax.swing.JDialog {
  AMORTISSEMENT a=new AMORTISSEMENT();
  SimpleDateFormat sp= new SimpleDateFormat("dd/MM/yyyy");
    public Amortissement(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Amortissement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Amortissement dialog = new Amortissement(new javax.swing.JFrame(), true);
